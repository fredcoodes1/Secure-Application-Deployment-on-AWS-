...
During testing, the Application Load Balancer was initially unreachable due to misconfigured security group rules. Correcting these rules restored access and reinforced the value of using Infrastructure as Code such as Terraform to avoid manual configuration errors and improve consistency.
